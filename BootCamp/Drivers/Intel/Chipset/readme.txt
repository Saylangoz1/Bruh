...
9.  Installing the INF Files After OS Installation
    ...
    9G. Installing the Windows 2012 INF Files After
        OS Installation
    9H. Installing the Windows 8.1 INF Files After 
        OS Installation
    9I. Installing the Windows 2012 R2 INF Files After
        OS Installation
...
and image creation for unattended installs of Windows 8.1 with tools such as Windows SIM
...
(In this step, you define basic disk configuration and other settings that are required 
for an unattended installation.)
	A. On your technician computer, insert the Windows 8.1 product DVD into the local 
	   DVD-ROM drive.
	B. On the desktop of the technician computer, navigate to the \Sources directory
	   on your DVD-ROM drive. Copy the Install.wim file from the Windows product DVD
           to a location on the computer.
...
and image creation for unattended installs of Windows 2012 R2 with tools such as Windows SIM
...
(In this step, you define basic disk configuration and other settings that are required 
for an unattended installation.)
	A. On your technician computer, insert the Windows 2012 R2 product DVD into the local 
	   DVD-ROM drive.
	B. On the desktop of the technician computer, navigate to the \Sources directory
	   on your DVD-ROM drive. Copy the Install.wim file from the Windows product DVD
           to a location on the computer.
...
************************************************************
* 9E.  INSTALLING THE Windows Server* 2008 R2 INF FILES AFTER 
*      OS INSTALLATION
************************************************************
Some Intel(R) chipset platforms already are supported by 
